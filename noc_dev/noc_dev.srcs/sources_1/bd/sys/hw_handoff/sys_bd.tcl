...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_nic_00, and set properties
  set axi_nic_00 [ create_bd_cell -type ip -vlnv user.org:user:axi_nic:1.0 axi_nic_00 ]
  set_property -dict [ list \
CONFIG.USE_1K_NOT_4K_FIFO_DEPTH {false} \
 ] $axi_nic_00

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /axi_nic_00/s00_axi]

  # Create instance: axi_nic_01, and set properties
  set axi_nic_01 [ create_bd_cell -type ip -vlnv user.org:user:axi_nic:1.0 axi_nic_01 ]
  set_property -dict [ list \
CONFIG.USE_1K_NOT_4K_FIFO_DEPTH {false} \
 ] $axi_nic_01
...
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /axi_nic_01/s00_axi]

  # Create instance: axi_nic_02, and set properties
  set axi_nic_02 [ create_bd_cell -type ip -vlnv user.org:user:axi_nic:1.0 axi_nic_02 ]
  set_property -dict [ list \
CONFIG.USE_1K_NOT_4K_FIFO_DEPTH {false} \
 ] $axi_nic_02
...
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /axi_nic_02/s00_axi]

  # Create instance: axi_nic_10, and set properties
  set axi_nic_10 [ create_bd_cell -type ip -vlnv user.org:user:axi_nic:1.0 axi_nic_10 ]
  set_property -dict [ list \
CONFIG.USE_1K_NOT_4K_FIFO_DEPTH {false} \
 ] $axi_nic_10
...
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /axi_nic_10/s00_axi]

  # Create instance: axi_nic_11, and set properties
  set axi_nic_11 [ create_bd_cell -type ip -vlnv user.org:user:axi_nic:1.0 axi_nic_11 ]
  set_property -dict [ list \
CONFIG.USE_1K_NOT_4K_FIFO_DEPTH {false} \
 ] $axi_nic_11
...
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /axi_nic_11/s00_axi]

  # Create instance: axi_nic_12, and set properties
  set axi_nic_12 [ create_bd_cell -type ip -vlnv user.org:user:axi_nic:1.0 axi_nic_12 ]
  set_property -dict [ list \
CONFIG.USE_1K_NOT_4K_FIFO_DEPTH {false} \
 ] $axi_nic_12
...
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /axi_nic_12/s00_axi]

  # Create instance: axi_nic_20, and set properties
  set axi_nic_20 [ create_bd_cell -type ip -vlnv user.org:user:axi_nic:1.0 axi_nic_20 ]
  set_property -dict [ list \
CONFIG.USE_1K_NOT_4K_FIFO_DEPTH {false} \
 ] $axi_nic_20
...
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /axi_nic_20/s00_axi]

  # Create instance: axi_nic_21, and set properties
  set axi_nic_21 [ create_bd_cell -type ip -vlnv user.org:user:axi_nic:1.0 axi_nic_21 ]
  set_property -dict [ list \
CONFIG.USE_1K_NOT_4K_FIFO_DEPTH {false} \
 ] $axi_nic_21
...
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /axi_nic_21/s00_axi]

  # Create instance: axi_nic_22, and set properties
  set axi_nic_22 [ create_bd_cell -type ip -vlnv user.org:user:axi_nic:1.0 axi_nic_22 ]
  set_property -dict [ list \
CONFIG.USE_1K_NOT_4K_FIFO_DEPTH {false} \
 ] $axi_nic_22
...
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /axi_nic_22/s00_axi]
...
CONFIG.NUM_MI {9} \
  ...
  # Create instance: router_00, and set properties
  set router_00 [ create_bd_cell -type ip -vlnv user.org:user:router:1.0 router_00 ]
  set_property -dict [ list \
CONFIG.N_INST {true} \
CONFIG.S_INST {false} \
CONFIG.W_INST {false} \
  ...
  # Create instance: router_01, and set properties
  set router_01 [ create_bd_cell -type ip -vlnv user.org:user:router:1.0 router_01 ]
  set_property -dict [ list \
CONFIG.ADDR_Y {1} \
CONFIG.W_INST {false} \
 ] $router_01

  # Create instance: router_02, and set properties
  set router_02 [ create_bd_cell -type ip -vlnv user.org:user:router:1.0 router_02 ]
  set_property -dict [ list \
CONFIG.ADDR_Y {2} \
CONFIG.N_INST {false} \
CONFIG.S_INST {true} \
CONFIG.W_INST {false} \
  ...
  # Create instance: router_10, and set properties
  set router_10 [ create_bd_cell -type ip -vlnv user.org:user:router:1.0 router_10 ]
  set_property -dict [ list \
CONFIG.ADDR_X {1} \
CONFIG.N_INST {true} \
CONFIG.S_INST {false} \
  ...
  # Create instance: router_11, and set properties
  set router_11 [ create_bd_cell -type ip -vlnv user.org:user:router:1.0 router_11 ]
  set_property -dict [ list \
CONFIG.ADDR_X {1} \
CONFIG.ADDR_Y {1} \
 ] $router_11

  # Create instance: router_12, and set properties
  set router_12 [ create_bd_cell -type ip -vlnv user.org:user:router:1.0 router_12 ]
  set_property -dict [ list \
CONFIG.ADDR_X {1} \
CONFIG.ADDR_Y {2} \
CONFIG.N_INST {false} \
CONFIG.S_INST {true} \
  ...
  # Create instance: router_20, and set properties
  set router_20 [ create_bd_cell -type ip -vlnv user.org:user:router:1.0 router_20 ]
  set_property -dict [ list \
CONFIG.ADDR_X {2} \
CONFIG.E_INST {false} \
CONFIG.N_INST {true} \
CONFIG.S_INST {false} \
  ...
  # Create instance: router_21, and set properties
  set router_21 [ create_bd_cell -type ip -vlnv user.org:user:router:1.0 router_21 ]
  set_property -dict [ list \
CONFIG.ADDR_X {2} \
CONFIG.ADDR_Y {1} \
CONFIG.E_INST {false} \
  ...
  # Create instance: router_22, and set properties
  set router_22 [ create_bd_cell -type ip -vlnv user.org:user:router:1.0 router_22 ]
  set_property -dict [ list \
CONFIG.ADDR_X {2} \
CONFIG.ADDR_Y {2} \
CONFIG.E_INST {false} \
...
CONFIG.S_INST {true} \
  ...
  connect_bd_intf_net -intf_net axi_nic_00_TX [get_bd_intf_pins axi_nic_00/TX] [get_bd_intf_pins router_00/L_IN]
  connect_bd_intf_net -intf_net axi_nic_01_TX [get_bd_intf_pins axi_nic_01/TX] [get_bd_intf_pins router_01/L_IN]
  connect_bd_intf_net -intf_net axi_nic_02_TX [get_bd_intf_pins axi_nic_02/TX] [get_bd_intf_pins router_02/L_IN]
  connect_bd_intf_net -intf_net axi_nic_10_TX [get_bd_intf_pins axi_nic_10/TX] [get_bd_intf_pins router_10/L_IN]
  connect_bd_intf_net -intf_net axi_nic_11_TX [get_bd_intf_pins axi_nic_11/TX] [get_bd_intf_pins router_11/L_IN]
  connect_bd_intf_net -intf_net axi_nic_12_TX [get_bd_intf_pins axi_nic_12/TX] [get_bd_intf_pins router_12/L_IN]
  connect_bd_intf_net -intf_net axi_nic_20_TX [get_bd_intf_pins axi_nic_20/TX] [get_bd_intf_pins router_20/L_IN]
  connect_bd_intf_net -intf_net axi_nic_21_TX [get_bd_intf_pins axi_nic_21/TX] [get_bd_intf_pins router_21/L_IN]
  connect_bd_intf_net -intf_net axi_nic_22_TX [get_bd_intf_pins axi_nic_22/TX] [get_bd_intf_pins router_22/L_IN]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins processing_system7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins axi_nic_00/s00_axi] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins axi_nic_01/s00_axi] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins axi_nic_02/s00_axi] [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M03_AXI [get_bd_intf_pins axi_nic_10/s00_axi] [get_bd_intf_pins processing_system7_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M04_AXI [get_bd_intf_pins axi_nic_11/s00_axi] [get_bd_intf_pins processing_system7_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M05_AXI [get_bd_intf_pins axi_nic_12/s00_axi] [get_bd_intf_pins processing_system7_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M06_AXI [get_bd_intf_pins axi_nic_20/s00_axi] [get_bd_intf_pins processing_system7_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M07_AXI [get_bd_intf_pins axi_nic_21/s00_axi] [get_bd_intf_pins processing_system7_0_axi_periph/M07_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M08_AXI [get_bd_intf_pins axi_nic_22/s00_axi] [get_bd_intf_pins processing_system7_0_axi_periph/M08_AXI]
  connect_bd_intf_net -intf_net router_00_E_OUT [get_bd_intf_pins router_00/E_OUT] [get_bd_intf_pins router_10/W_IN]
  connect_bd_intf_net -intf_net router_00_L_OUT [get_bd_intf_pins axi_nic_00/RX] [get_bd_intf_pins router_00/L_OUT]
  connect_bd_intf_net -intf_net router_00_N_OUT [get_bd_intf_pins router_00/N_OUT] [get_bd_intf_pins router_01/S_IN]
  connect_bd_intf_net -intf_net router_01_E_OUT [get_bd_intf_pins router_01/E_OUT] [get_bd_intf_pins router_11/W_IN]
  connect_bd_intf_net -intf_net router_01_L_OUT [get_bd_intf_pins axi_nic_01/RX] [get_bd_intf_pins router_01/L_OUT]
  connect_bd_intf_net -intf_net router_01_N_OUT [get_bd_intf_pins router_01/N_OUT] [get_bd_intf_pins router_02/S_IN]
  connect_bd_intf_net -intf_net router_01_S_OUT [get_bd_intf_pins router_00/N_IN] [get_bd_intf_pins router_01/S_OUT]
  connect_bd_intf_net -intf_net router_02_E_OUT [get_bd_intf_pins router_02/E_OUT] [get_bd_intf_pins router_12/W_IN]
  connect_bd_intf_net -intf_net router_02_L_OUT [get_bd_intf_pins axi_nic_02/RX] [get_bd_intf_pins router_02/L_OUT]
  connect_bd_intf_net -intf_net router_02_S_OUT [get_bd_intf_pins router_01/N_IN] [get_bd_intf_pins router_02/S_OUT]
  connect_bd_intf_net -intf_net router_10_E_OUT [get_bd_intf_pins router_10/E_OUT] [get_bd_intf_pins router_20/W_IN]
  connect_bd_intf_net -intf_net router_10_L_OUT [get_bd_intf_pins axi_nic_10/RX] [get_bd_intf_pins router_10/L_OUT]
  connect_bd_intf_net -intf_net router_10_N_OUT [get_bd_intf_pins router_10/N_OUT] [get_bd_intf_pins router_11/S_IN]
  connect_bd_intf_net -intf_net router_10_W_OUT [get_bd_intf_pins router_00/E_IN] [get_bd_intf_pins router_10/W_OUT]
  connect_bd_intf_net -intf_net router_11_E_OUT [get_bd_intf_pins router_11/E_OUT] [get_bd_intf_pins router_21/W_IN]
  connect_bd_intf_net -intf_net router_11_L_OUT [get_bd_intf_pins axi_nic_11/RX] [get_bd_intf_pins router_11/L_OUT]
  connect_bd_intf_net -intf_net router_11_N_OUT [get_bd_intf_pins router_11/N_OUT] [get_bd_intf_pins router_12/S_IN]
  connect_bd_intf_net -intf_net router_11_S_OUT [get_bd_intf_pins router_10/N_IN] [get_bd_intf_pins router_11/S_OUT]
  connect_bd_intf_net -intf_net router_11_W_OUT [get_bd_intf_pins router_01/E_IN] [get_bd_intf_pins router_11/W_OUT]
  connect_bd_intf_net -intf_net router_12_E_OUT [get_bd_intf_pins router_12/E_OUT] [get_bd_intf_pins router_22/W_IN]
  connect_bd_intf_net -intf_net router_12_L_OUT [get_bd_intf_pins axi_nic_12/RX] [get_bd_intf_pins router_12/L_OUT]
  connect_bd_intf_net -intf_net router_12_S_OUT [get_bd_intf_pins router_11/N_IN] [get_bd_intf_pins router_12/S_OUT]
  connect_bd_intf_net -intf_net router_12_W_OUT [get_bd_intf_pins router_02/E_IN] [get_bd_intf_pins router_12/W_OUT]
  connect_bd_intf_net -intf_net router_20_L_OUT [get_bd_intf_pins axi_nic_20/RX] [get_bd_intf_pins router_20/L_OUT]
  connect_bd_intf_net -intf_net router_20_N_OUT [get_bd_intf_pins router_20/N_OUT] [get_bd_intf_pins router_21/S_IN]
  connect_bd_intf_net -intf_net router_20_W_OUT [get_bd_intf_pins router_10/E_IN] [get_bd_intf_pins router_20/W_OUT]
  connect_bd_intf_net -intf_net router_21_L_OUT [get_bd_intf_pins axi_nic_21/RX] [get_bd_intf_pins router_21/L_OUT]
  connect_bd_intf_net -intf_net router_21_N_OUT [get_bd_intf_pins router_21/N_OUT] [get_bd_intf_pins router_22/S_IN]
  connect_bd_intf_net -intf_net router_21_S_OUT [get_bd_intf_pins router_20/N_IN] [get_bd_intf_pins router_21/S_OUT]
  connect_bd_intf_net -intf_net router_21_W_OUT [get_bd_intf_pins router_11/E_IN] [get_bd_intf_pins router_21/W_OUT]
  connect_bd_intf_net -intf_net router_22_L_OUT [get_bd_intf_pins axi_nic_22/RX] [get_bd_intf_pins router_22/L_OUT]
  connect_bd_intf_net -intf_net router_22_S_OUT [get_bd_intf_pins router_21/N_IN] [get_bd_intf_pins router_22/S_OUT]
  connect_bd_intf_net -intf_net router_22_W_OUT [get_bd_intf_pins router_12/E_IN] [get_bd_intf_pins router_22/W_OUT]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_nic_00/s00_axi_aclk] [get_bd_pins axi_nic_01/s00_axi_aclk] [get_bd_pins axi_nic_02/s00_axi_aclk] [get_bd_pins axi_nic_10/s00_axi_aclk] [get_bd_pins axi_nic_11/s00_axi_aclk] [get_bd_pins axi_nic_12/s00_axi_aclk] [get_bd_pins axi_nic_20/s00_axi_aclk] [get_bd_pins axi_nic_21/s00_axi_aclk] [get_bd_pins axi_nic_22/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/M04_ACLK] [get_bd_pins processing_system7_0_axi_periph/M05_ACLK] [get_bd_pins processing_system7_0_axi_periph/M06_ACLK] [get_bd_pins processing_system7_0_axi_periph/M07_ACLK] [get_bd_pins processing_system7_0_axi_periph/M08_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins router_00/CLOCK] [get_bd_pins router_01/CLOCK] [get_bd_pins router_02/CLOCK] [get_bd_pins router_10/CLOCK] [get_bd_pins router_11/CLOCK] [get_bd_pins router_12/CLOCK] [get_bd_pins router_20/CLOCK] [get_bd_pins router_21/CLOCK] [get_bd_pins router_22/CLOCK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins axi_nic_00/s00_axi_aresetn] [get_bd_pins axi_nic_01/s00_axi_aresetn] [get_bd_pins axi_nic_02/s00_axi_aresetn] [get_bd_pins axi_nic_10/s00_axi_aresetn] [get_bd_pins axi_nic_11/s00_axi_aresetn] [get_bd_pins axi_nic_12/s00_axi_aresetn] [get_bd_pins axi_nic_20/s00_axi_aresetn] [get_bd_pins axi_nic_21/s00_axi_aresetn] [get_bd_pins axi_nic_22/s00_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M05_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M06_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M07_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M08_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_reset [get_bd_pins router_00/RESET] [get_bd_pins router_01/RESET] [get_bd_pins router_02/RESET] [get_bd_pins router_10/RESET] [get_bd_pins router_11/RESET] [get_bd_pins router_12/RESET] [get_bd_pins router_20/RESET] [get_bd_pins router_21/RESET] [get_bd_pins router_22/RESET] [get_bd_pins rst_processing_system7_0_100M/peripheral_reset]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_nic_00/s00_axi/reg0] SEG_axi_nic_00_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_nic_01/s00_axi/reg0] SEG_axi_nic_01_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_nic_02/s00_axi/reg0] SEG_axi_nic_02_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_nic_10/s00_axi/reg0] SEG_axi_nic_10_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C40000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_nic_11/s00_axi/reg0] SEG_axi_nic_11_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C50000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_nic_12/s00_axi/reg0] SEG_axi_nic_12_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C60000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_nic_20/s00_axi/reg0] SEG_axi_nic_20_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C70000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_nic_21/s00_axi/reg0] SEG_axi_nic_21_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C80000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_nic_22/s00_axi/reg0] SEG_axi_nic_22_reg0
...
preplace inst router_20 -pg 1 -lvl 4 -y -250 -defaultsOSRD
preplace inst router_21 -pg 1 -lvl 4 -y -1020 -defaultsOSRD
preplace inst router_22 -pg 1 -lvl 4 -y -1760 -defaultsOSRD
preplace inst axi_nic_20 -pg 1 -lvl 4 -y -410 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 1 -y -700 -defaultsOSRD
preplace inst axi_nic_21 -pg 1 -lvl 4 -y -1190 -defaultsOSRD
preplace inst axi_nic_22 -pg 1 -lvl 4 -y -1930 -defaultsOSRD
preplace inst axi_nic_10 -pg 1 -lvl 3 -y -440 -defaultsOSRD
preplace inst router_00 -pg 1 -lvl 2 -y -290 -defaultsOSRD
preplace inst axi_nic_11 -pg 1 -lvl 3 -y -1220 -defaultsOSRD
preplace inst router_01 -pg 1 -lvl 2 -y -1040 -defaultsOSRD
preplace inst axi_nic_12 -pg 1 -lvl 3 -y -1950 -defaultsOSRD
preplace inst axi_nic_00 -pg 1 -lvl 2 -y -460 -defaultsOSRD
preplace inst router_02 -pg 1 -lvl 2 -y -1770 -defaultsOSRD
preplace inst axi_nic_01 -pg 1 -lvl 2 -y -1210 -defaultsOSRD
preplace inst axi_nic_02 -pg 1 -lvl 2 -y -1970 -defaultsOSRD
preplace inst router_10 -pg 1 -lvl 3 -y -270 -defaultsOSRD
preplace inst router_11 -pg 1 -lvl 3 -y -1040 -defaultsOSRD
preplace inst router_12 -pg 1 -lvl 3 -y -1780 -defaultsOSRD
preplace inst processing_system7_0_axi_periph -pg 1 -lvl 1 -y -1610 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y -1120 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 4 1080J -1340 NJ -1340 NJ -1340 3320J
preplace netloc router_11_S_OUT 1 2 2 2240 -930 2720
preplace netloc router_20_W_OUT 1 2 3 2260 -160 NJ -160 3280
preplace netloc router_00_E_OUT 1 2 1 2130
preplace netloc router_21_S_OUT 1 3 2 2800 -920 3290
preplace netloc router_00_L_OUT 1 1 2 1160 -540 2140
preplace netloc router_11_E_OUT 1 3 1 2730
preplace netloc router_20_N_OUT 1 3 2 2820 -900 3300
preplace netloc router_02_S_OUT 1 1 2 1140 -1620 2130
preplace netloc axi_nic_20_TX 1 3 2 2810 -500 3290
preplace netloc axi_nic_22_TX 1 3 2 2820 -1850 3280
preplace netloc router_11_L_OUT 1 2 2 2260 -1300 2710
preplace netloc router_22_W_OUT 1 2 3 2260 -1660 NJ -1660 3280
preplace netloc processing_system7_0_axi_periph_M08_AXI 1 1 3 NJ -1530 NJ -1530 2740
preplace netloc processing_system7_0_axi_periph_M03_AXI 1 1 2 NJ -1630 2200
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 1 1 1100J
preplace netloc router_12_S_OUT 1 2 2 2240 -1680 2730
preplace netloc router_01_N_OUT 1 1 2 1150 -1660 2150
preplace netloc axi_nic_11_TX 1 2 2 2250 -1310 2720
preplace netloc axi_nic_10_TX 1 2 2 2250 -530 2720
preplace netloc router_01_L_OUT 1 1 2 1160 -1290 2130
preplace netloc router_10_W_OUT 1 1 3 1160J -170 NJ -170 2710
preplace netloc processing_system7_0_axi_periph_M07_AXI 1 1 3 NJ -1550 NJ -1550 2770
preplace netloc processing_system7_0_M_AXI_GP0 1 0 2 0 -1890 1050
preplace netloc router_21_N_OUT 1 3 2 2820 -1650 3300
preplace netloc router_21_L_OUT 1 3 2 2820 -1270 3280
preplace netloc router_12_L_OUT 1 2 2 2260 -2030 2710
preplace netloc router_10_L_OUT 1 2 2 2260 -520 2710
preplace netloc router_21_W_OUT 1 2 3 2260 -910 NJ -910 3280
preplace netloc router_12_W_OUT 1 1 3 1160J -1670 NJ -1670 2710
preplace netloc processing_system7_0_axi_periph_M05_AXI 1 1 2 NJ -1590 2160
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 0 -990 1050
preplace netloc router_22_S_OUT 1 3 2 2800 -1670 3320
preplace netloc router_11_N_OUT 1 2 2 2250 -1640 2730
preplace netloc axi_nic_21_TX 1 3 2 2810 -1280 3290
preplace netloc axi_nic_00_TX 1 1 2 1160 -380 2130
preplace netloc router_02_E_OUT 1 2 1 2170
preplace netloc router_10_E_OUT 1 3 1 2720
preplace netloc processing_system7_0_axi_periph_M02_AXI 1 1 1 1080J
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 0 4 -30 -1910 1130 -660 2230J -660 2790
preplace netloc router_10_N_OUT 1 2 2 2250 -900 2730
preplace netloc router_00_N_OUT 1 1 2 1150 -940 2150
preplace netloc router_12_E_OUT 1 3 1 2800
preplace netloc processing_system7_0_axi_periph_M06_AXI 1 1 3 NJ -1570 NJ -1570 2750
preplace netloc rst_processing_system7_0_100M_peripheral_reset 1 1 3 1120 -700 2210 -700 2780
preplace netloc processing_system7_0_FIXED_IO 1 1 4 1070J -1320 NJ -1320 NJ -1320 3310J
preplace netloc axi_nic_02_TX 1 1 2 1160 -1860 2130
preplace netloc router_11_W_OUT 1 1 3 1160J -920 NJ -920 2710
preplace netloc router_01_E_OUT 1 2 1 2220
preplace netloc router_01_S_OUT 1 1 2 1150 -930 2130
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 0 2 -10 -1900 1060
preplace netloc processing_system7_0_FCLK_CLK0 1 0 4 -20 -450 1110 -1890 2180 -1650 2760
preplace netloc router_22_L_OUT 1 3 2 2790 -2010 3320
preplace netloc axi_nic_12_TX 1 2 2 2250 -2040 2730
preplace netloc router_02_L_OUT 1 1 2 1140 -1680 2150
preplace netloc axi_nic_01_TX 1 1 2 1150 -1300 2140
preplace netloc router_20_L_OUT 1 3 2 2820 -490 3280
preplace netloc processing_system7_0_axi_periph_M04_AXI 1 1 2 NJ -1610 2190
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 1 1 1090J
levelinfo -pg 1 -50 850 2030 2610 3180 3790 -top -2050 -bot 1830
",
}
